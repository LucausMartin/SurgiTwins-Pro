...
if __name__ == '__main__':
    ...
    video_source = r"F:\pythonpro\surgery\scikit-surgerytutorial01\data\p2ilf-10-9-test-ppt.mp4"
    viewer = OverlayApp(video_source)

    model_dir = 'F:\pythonpro\surgery\scikit-surgerytutorial01\data\stl'
